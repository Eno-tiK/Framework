Surface.prototype.cube = (point = new Point(0, 0, 0), size = 6) => {
    ...
    const points = [
        ...
        new Point(x+size,y+size,z-size),
        //Точки на гранях
        new Point(x-size,y+size3,z-size),
        new Point(x-size,y-size3,z-size),
        new Point(x+size,y+size3,z-size),
        new Point(x+size,y-size3,z-size),
        new Point(x+size,y+size3,z+size),
        ...
        new Point(x+size3,y-size,z-size),
        new Point(x-size3,y-size,z-size),
        new Point(x+size3,y-size,z+size),
        new Point(x-size3,y-size,z+size),
        new Point(x+size3,y+size,z+size),
        ...
        new Point(x+size,y+size,z+size3),
        new Point(x+size,y+size,z-size3),
        new Point(x-size,y+size,z+size3),
        new Point(x-size,y+size,z-size3),
        new Point(x-size,y-size,z+size3),
        ...
        new Point(x+size3,y+size3,z+size),
        new Point(x-size3,y+size3,z+size),
        new Point(x-size3,y-size3,z+size),
        new Point(x+size3,y-size3,z+size),
        new Point(x+size3,y+size3,z-size),
        ...
        new Point(x+size3,y+size,z+size3),
        new Point(x-size3,y+size,z+size3),
        new Point(x-size3,y+size,z-size3),
        new Point(x+size3,y+size,z-size3),
        new Point(x+size3,y-size,z+size3),
        ...
        new Point(x+size,y+size3,z+size3),
        new Point(x+size,y-size3,z+size3),
        new Point(x+size,y-size3,z-size3),
        new Point(x+size,y+size3,z-size3),
        new Point(x-size,y+size3,z+size3),
